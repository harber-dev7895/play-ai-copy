    ...
    <>
      <div className="max-w-[1320px] mx-auto my-[30px]">
        <div className="lg:w-[58.33333333%] mx-auto">
          <TitlePageUser title="คืนยอดเสีย" />
          ...
          <div className="bg-box-overview rounded-[6px] py-6 px-4 mt-4">
            <div className="animated animatedFadeInUp fadeInUp">
              <div className="grid grid-cols-3 gap-2 mb-4">
                {bannerList.map((item) => {
                  return (
                    <Image
                      key={item}
                      src={`/images/banner/cash-back.png`}
                      alt={""}
                      width={702}
                      height={250}
                      className="w-full"
              ...
              <div className="flex justify-between font-light text-sm my-8">
                <p>คืนยอดเสีย 5.00%</p>
                <p>ยอดเริ่มต้น 10 บาท</p>
              </div>
              ...
              <div className="bg-[#0003] p-2 flex justify-between rounded-[6px] mt-6 mb-4">
                <div className="flex items-center gap-1">
                  ...
                  <div className="text-sm">
                    <p className="font-light">ยอดเสียของคุณ</p>
